...
class PermissionsRelationManager extends RelationManager
{
    ...
    {
        return $this->pageClass === EditRole::class;
    }
    ...
    {
        return __('app.models.permission.label');
    }

    public static function getPluralModelLabel(): string
    {
        return __('app.models.permission.plural_label');
    }
    ...
    protected function configureCreateAction(Tables\Actions\CreateAction $action): void
    {
        ...
        $action
            ->action(null)
            ->url(PermissionResource::getUrl('create'));
    }
    ...
    protected function configureEditAction(Tables\Actions\EditAction $action): void
    {
        ...
        $action
            ->action(null)
            ->url(fn (Model $record): string => PermissionResource::getUrl('edit', $record));
    }
    ...
    protected function configureViewAction(Tables\Actions\ViewAction $action): void
    {
        ...
        $action
            ->action(null)
            ->url(fn (Model $record): string => PermissionResource::getUrl('view', $record));
    }
